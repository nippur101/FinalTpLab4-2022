     ...
     <div class="content">
          ...
          <form action="<?php echo FRONT_ROOT . "Reserve/GenerateReserve" ?>" method="POST" class="login-form bg-dark-alpha p-5 bg-light">
               <div class="form-group">
                    ...
                    <input type="date" name="keeperFinalDate" value="<?php echo $event->getFinalDate(); ?>" class="form-control form-control-lg" disabled>

                    <label for="">Tu lo necesitas desde:</label>
                    <input type="date" name="neededStartDate" value="<?php echo $needed->getStartDate(); ?>" class="form-control form-control-lg" disabled>

                    <label for="">Hasta:</label>
                    <input type="date" name="neededFinalDate" value="<?php echo $needed->getFinalDate(); ?>" class="form-control form-control-lg" disabled>

                    <label for="">Lo contratarias:</label>
                    <input type="text" name="keeperAvaiableDays" value="<?php echo $keeperInterval->format('%a') . " dias"; ?>" class="form-control form-control-lg" disabled>

                    <label for="">Y tu necesitas:</label>
                    <input type="text" name="neededAvaiableDays" value="<?php echo $requestedInterval->format('%a') . " dias"; ?>" class="form-control form-control-lg" disabled>

                    <label for="">Con cada dia a un costo de:</label>
                    <input type="text" name="keeperStayCost" value="<?php echo $keeper->getStayCost(); ?>" class="form-control form-control-lg" disabled>
